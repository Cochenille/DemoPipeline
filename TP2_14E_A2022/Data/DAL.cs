...
namespace TP214E.Data
{
    public class DAL
    {
        ...
        public List<Membre> GetMembres()
        {
            ...
            {
                MessageBox.Show("Impossible blablablabweriuhweribwerighweruh de se connecter à la base de données " + ex.Message, "Erreur", MessageBoxButton.OK, MessageBoxImage.Error);
